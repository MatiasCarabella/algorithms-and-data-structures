...
/**
 * Represents a building with multiple floors and offices.
 * Demonstrates search algorithms and Big O notation concepts.
 */
public class Building {
    ...
    public boolean getSensor(int floor, int office) throws Exception {
        if (floor < 1 || floor > FLOORS || office < 1 || office > OFFICES_PER_FLOOR) {
            throw new Exception("Invalid floor/office combination (" + floor + "," + office + ") - No sensor available");
        }
