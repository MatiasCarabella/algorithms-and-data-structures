...
public class Menu {
        ...
        do {
            ...
            switch (subMenuOption) {
                ...
                case 4:
                    ...
                    word = words[Integer.parseInt(wordOption) - 1];
                    System.out.println("The selected word '" + word + "' appears " +
                        Counter.occurrenceCount(words, word) + " times.");
                    pressEnterToContinue();
                    break;
                case 0:
                    System.out.println("Goodbye!");
    ...
    private void demonstrateQueueOperations() {
        ...
        if (!queue.isEmpty()) {
            ...
            System.out.println("Front of queue: Code: " + frontOrder.getCode() +
                ", Customer: " + frontOrder.getCustomerName() +
                ", Brick Quantity: " + frontOrder.getBrickQuantity());
        }
        ...
        System.out.println("\nDequeued orders:");
        System.out.println("Order 1: Code: " + dequeuedOrder1.getCode() +
            ", Customer: " + dequeuedOrder1.getCustomerName() +
            ", Brick Quantity: " + dequeuedOrder1.getBrickQuantity());
        System.out.println("Order 2: Code: " + dequeuedOrder2.getCode() +
            ", Customer: " + dequeuedOrder2.getCustomerName() +
            ", Brick Quantity: " + dequeuedOrder2.getBrickQuantity());
    }
    ...
    private void demonstrateHuffmanTree() {
        ...
        System.out.println("Note: This demo requires a text file to compress.");
        System.out.println("To use this feature:");
        System.out.println("1. Create a text file named 'test.txt' in the project root");
        System.out.println("2. Add some text content to the file");
        System.out.println("3. Run this option again");
        System.out.println("\nThe compressed file will be saved as 'test.txt.compress'");
        System.out.println("\nSkipping Huffman compression demo (no input file).");
        
        // Uncomment the following lines when you have a test file:
        // HuffmanTree huffmanTree = new HuffmanTree();
        // huffmanTree.compress("test.txt");
    }
