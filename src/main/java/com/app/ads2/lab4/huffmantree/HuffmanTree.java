 ...
 * variable-length codes to characters based on their frequency of occurrence.
...
public class HuffmanTree {
    ...
    /**
     * Loads the frequency table from a file.
     * Counts the occurrence of each character in the file.
     */
    ...
    /**
     * Inserts a node into the sorted list of trees.
     * List is sorted by frequency in ascending order.
     */
    ...
    /**
     * Creates a sorted list of trees from the frequency table.
     * Each character becomes a leaf node in its own tree.
     */
    void createTreeList() {
        int position = 0;
        char character;
    ...
    /**
     * Processes the list of trees to build the final Huffman tree.
     * Repeatedly combines the two trees with lowest frequencies until
            ...
            if (currentNode != null) {
                ...
                while (currentNode.next != null) {
                    ...
                    TreeNode newTreeNode = new TreeNode('*', 
                        node1.root.frequency + node2.root.frequency, false);
     ...
     * Traverses the tree: left = 0, right = 1
     * 
    ...
    /**
     * Processes the buffer and writes complete bytes to the file.
     * Returns the remaining bits that don't form a complete byte.
     */
